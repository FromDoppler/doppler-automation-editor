export const automation_en_translations = {
  "automation_editor": {
    ...
    "canvas": {
      ...
      "push_icon": "Push",
      "push_domain": "domain",
      "push_placeholder_message": "Define the Push notification message",
      "push_placeholder_title": "Define the Push notification title",
    ...
    "sidebar": {
      ...
      "campaign_dmarc_validation_subscribers_part1": "Verify your domain to continue. ",
      "campaign_dmarc_validation_part2": "Have questions? Press ",
      ...
      "campaign_dmarc_managed_domain_message": "To ensure your emails are delivered successfully, we use a Doppler-managed domain. For example: {{userName}}@{{idUser}}.{{managedSendingDomain}}",
      ...
      "Push_notification_domains_selection_title": "Select domain:",
      "Domains_Select": "Select domain:",
      ...
      "Push_notification_campaign_send_repetitive_description": "Choose what type of date you will use to give a frequency to your Email Automation Campaign",
      ...
      "push_image_large_tip": "Recommended size: 1200x628 px. Only supported in some browsers.",
      "push_image_small_tip": "Recommended size: 192x192 px.",
      ...
      "push_button_section" : "Buttons",
      "push_button_content" : "Button",
      "push_button_section_info" : "You can include a maximum of two buttons in the Push Notification",
      "push_button_section_text" : "Text button {{index}}:",
      "push_button_section_text_placeholder" : "See Offers",
      "push_button_section_icon" : "Icon:",
      "push_button_section_url" : "URL button {{index}}:",
      "push_button_section_url_placeholder" : "https://my-site.site/offers",
      "push_button_section_add_action" : "+ Add button",
      "push_label_custom_field_info": "You can create your custom variables by going to ",
      "push_label_custom_field_info-link": "Lists/Custom Fields",
    ...
    "Domains_grid": {
      ...
      "scheduled_subtitle": "The listed domains are active. Only those who have subscribed to push notifications will receive them.",
      "header_domain_column": "Domains",
      "header_subscriber_column": "Subscribers"
    }
  },
  "automationTemplates": {
    "breadcrumb": {
  ...
  "automationTypes": {
    "info": {
      ...
      "pushConfigurationMissing_message": "Activate Push Notifications after configuring your domain to start reaching your users in real time.",
      "pushConfigurationMissing_action": "CONFIGURE NOW",
      "pushTrialExpired_message": "Your trial period has ended. Sign up for a plan to continue communicating with your users instantly.",
      "pushTrialExpired_action": "PURCHASE NOW",
      "continue": "CONTINUE",
