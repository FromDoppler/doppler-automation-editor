export const automation_es_translations = {
  "automation_editor": {
    ...
    "push_icon": "Push",
    "push_domain": "dominio",
    "push_placeholder_message": "Define el contenido del mensaje",
    "push_placeholder_title": "Define el contenido del titulo",
  ...
  "lists_grid_empty": {
    ...
    "sidebar": {
      ...
      "campaign_dmarc_validation_subscribers_part1": "Por la cantidad de Contactos en tu cuenta, necesitas un dominio propio para seguir enviando. ",
      "campaign_dmarc_validation_part2": "¿Tienes dudas? Presiona. ",
      ...
      "campaign_dmarc_managed_domain_message": "Para asegurar que tus correos lleguen a destino, usamos un dominio administrado por Doppler. Por ejemplo: {{userName}}@{{idUser}}.{{managedSendingDomain}}",
      ...
      "push_image_large_tip": "Tamaño recomendado 1200x628 px. Solo compatible con algunos navegadores.",
      "push_image_small_tip": "Tamaño recomendado 192x192 px.",
      ...
      "push_button_section" : "Botones",
      "push_button_content" : "Boton",
      "push_button_section_info" : "Puedes incluir un máximo de dos botones en la Notificacón Push",
      "push_button_section_text" : "Texto botón {{index}}:",
      "push_button_section_text_placeholder" : "Ver Ofertas",
      "push_button_section_icon" : "Icono:",
      "push_button_section_url" : "URL botón {{index}}:",
      "push_button_section_url_placeholder" : "https://mi-sitio.site/ofertas",
      "push_button_section_add_action" : "+ Agregar botón",
      "push_label_custom_field_info" : "Puedes crear tus variables personalizadas ingresando en ",
      "push_label_custom_field_info-link": "Listas/Campos Personalizados",
  ...
  "stop_modal": {
    ...
    "Domains_grid": {
      ...
      "empty_description1": "Hazlo y luego regresa a continuar la edición de tu Automation.",
      "empty_description": "Puede verificarcarlo en <a href='/ControlPanel/CampaignsPreferences/SiteTrackingSettings'>Seguimiento en Sitio</a> y luego regresa a continuar la edición de tu Automation.",
