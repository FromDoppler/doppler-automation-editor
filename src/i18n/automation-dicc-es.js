var automation_es_translations = {
    ...
    "automation_editor": {
      ...
      "lists_scheduled_grid": {
        ...
        "all_contacts": "Enviar a todos mis contactos (Todas tus Listas serán seleccionadas)",
      ...
      "sidebar": {
        ...
        "Push_notification_campaign_tip_link_url": "https://help.fromdoppler.com/es/automation-notificaciones-push",
        ...
        "visited_products": {
          ...
          "drop_down_ecommerce_errors": {
            "error2": "¡Ouch! No has habilitado el periodo de prueba de Seguimiento en Sitio. <a href='/Automation/EditorConfig?idTaskType=0' class='text--underline' target='_self'>HABILÍTALO AHORA</a>.",
