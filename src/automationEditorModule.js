      ...
      $routeProvider.when('/AutomationMFE/EditorConfig?', {
        ...
        resolve: {
          automationData: [
            ...
            'settingsService',
            '$q',
            function ($location, automation, $translate, settingsService, $q) {
              ...
              return $q
                .all([$translate.onReady(), settingsService.getSettings()])
                .then(function () {
                  return automation.load(
                    idTaskType,
                    idScheduledTask,
                    idCampaign
                  );
  ...
  .controller('AutomationEditorCtrl', [
    ...
    function (
      ...
      $scope.isDynamicAutomation =
        automationData.data.automationType === AUTOMATION_TYPE.ABANDONED_CART ||
        automationData.data.automationType ===
      ...
      $scope.showAutomationTypes =
        automationData.data.automationType === AUTOMATION_TYPE.NONE;
      ...
      if (urlParams && urlParams.idCampaign) {
        $scope.$evalAsync(function () {
          campaignComponent = automation.getEmailComponentById(
            parseInt(urlParams.idCampaign)
          );
