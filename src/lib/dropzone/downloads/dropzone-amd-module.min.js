  ...
  return (
    ...
    function () {
      var c,
        ...
        n = [].slice;
      (e = 'undefined' != typeof b && null !== b ? b : require('emitter')),
        (j = function () {}),
        (c = (function (a) {
          function b(a, d) {
            var e, f, g;
          ...
          return (
            ...
            (c = function () {
              ...
              for (
                d = arguments[0],
                  c = 2 <= arguments.length ? n.call(arguments, 1) : [],
                  f = 0,
                  g = c.length;
                g > f;
                f++
            ...
            (b.prototype.uploadFiles = function (a) {
              ...
              if (
                (this.options.uploadMultiple &&
                  this.emit('sendingmultiple', a, t, e),
                'FORM' === this.element.tagName)
              )
                for (
                  ...
                  if (
                    ...
                    (!m ||
                      ('checkbox' !== (H = m.toLowerCase()) && 'radio' !== H) ||
                      k.checked) &&
                      e.append(l, k.value);
              for (
                j = C = 0, I = a.length - 1;
