...
!(function (a, b) {
  'use strict';
  b.module('angular-moment', ['gdi2290.moment']),
    b.module('angular-momentjs', ['gdi2290.moment']),
    b.module('ngMoment', ['gdi2290.moment']),
    b.module('ngMomentjs', ['gdi2290.moment']),
    b.module('ngMomentJS', ['gdi2290.moment']),
    b.module('gdi2290.amTimeAgo', []),
    b.module('gdi2290.amDateFormat', []),
    b.module('gdi2290.moment-service', []),
    b.module('gdi2290.moment', [
      'gdi2290.moment-service',
      'gdi2290.amDateFormat',
      'gdi2290.amTimeAgo',
    ]),
    b.module('gdi2290.amDateFormat').filter('amDateFormat', [
      '$moment',
      function (a) {
        return function (b, c) {
    ...
    b.module('gdi2290.amTimeAgo').directive('amTimeAgo', [
      '$moment',
      '$timeout',
      function (a, c) {
        function d(a) {
        ...
        return function (e, f, g) {
          ...
          e.$watch(g.amTimeAgo, function (a) {
            return d(a)
              ? (h(), void (k && (f.text(''), (k = null))))
              : (b.isNumber(a) && (a = new Date(a)), (k = a), void j());
          }),
        ...
        (this.$get = [
          ...
          function (d, f, g) {
            ...
            if (c) {
              ...
              b &&
                (g.moment.lang ? g.moment.lang(b, e) : g.moment.locale(b, e));
