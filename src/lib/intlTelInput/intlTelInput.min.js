    ...
    return (function () {
            ...
            f(e, [
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.g &&
                      (b.body.classList.add('iti-mobile'),
                      this.d.dropdownContainer ||
                        (this.d.dropdownContainer = b.body)),
              ...
              },
              {
                ...
                value: function () {
                  this.m.classList.add('iti__hide'),
                    ...
                    this.d.dropdownContainer &&
                      (this.g || a.removeEventListener('scroll', this._a4),
              ...
              },
              {
                ...
                value: function () {
                  'auto' === this.d.initialCountry &&
                    ((this.j = a.intlTelInputGlobals.autoCountry),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  this.hiddenInput &&
                    b &&
                    b.removeEventListener('submit', this._a14),
                    this.d.autoHideDialCode &&
                      (b && b.removeEventListener('submit', this._a8),
                  ...
                  d.parentNode.insertBefore(this.a, d),
                    ...
                    delete a.intlTelInputGlobals.instances[this.id];
                },
              },
              {
                key: 'getExtension',
                value: function () {
                  return a.intlTelInputUtils
              ...
              },
              {
                ...
                value: function () {
                  ...
                  return a.intlTelInputUtils
                    ? intlTelInputUtils.isValidNumber(b, c)
                    : null;
                },
              },
              {
      ...
      return (
        (a.intlTelInputGlobals.loadUtils = function (b) {
          if (
            !a.intlTelInputUtils &&
            !a.intlTelInputGlobals.startedLoadingUtilsScript
          ) {
            if (
              ((a.intlTelInputGlobals.startedLoadingUtilsScript = !0),
              'undefined' != typeof Promise)
            )
        ...
        (a.intlTelInputGlobals.defaults = k),
        (a.intlTelInputGlobals.version = '16.0.3'),
        function (b, c) {
          var d = new o(b, c);
          return (
            d._init(),
            b.setAttribute('data-intl-tel-input-id', d.id),
            (a.intlTelInputGlobals.instances[d.id] = d),
            d
          );
        }
      );
