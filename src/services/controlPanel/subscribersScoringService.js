(function () {
  ...
  subscribersScoringService.$inject = ['$http'];
  ...
  function subscribersScoringService($http) {
    ...
    function saveScoringPreferences(scoringInformation) {
      return $http
        .post(
          '/ControlPanel/CampaignsPreferences/SaveScoringPreferences',
          scoringInformation
        )
    ...
    function getScoringPreferences() {
      return $http
        .get('/ControlPanel/CampaignsPreferences/GetScoringPreferences')
        .then(function (response) {
          return response.data;
        });
    }
