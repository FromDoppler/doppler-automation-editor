(function () {
  ...
  angular.module('dopplerApp').factory('tiendanubeService', tiendanubeService);

  tiendanubeService.$inject = ['$http'];
  ...
  function tiendanubeService($http) {
    ...
    function getIntegrationStatus() {
      return $http
        .get('/Integration/Integration/GetTiendanubeIntegrationStatus')
    ...
    function connect(userData) {
      return $http
        .post('/Integration/Integration/ConnectTiendanube', userData)
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function disconnect() {
      return $http
        .post('/Integration/Integration/TiendanubeDisconnect')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function getUserLists() {
      return $http
        .get('/Integration/Integration/GetTiendanubeUserLists')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function getTiendanubeEntities() {
      return $http
        .get('/Integration/Integration/GetTiendanubeModules')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function getTiendanubeFields(module) {
      return $http
        .get('/Integration/Integration/GetTiendanubeFields', {
          params: {
            module: module,
          },
        })
    ...
    function manualSync() {
      return $http
        .get('/Integration/Integration/SynchAlltiendanubeLists')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function synchTiendanubeLists(idList) {
      return $http
        .post('/Integration/Integration/SynchTiendanubeLists', {
    ...
    function associateTiendanubeFieldMapping(idList, tiendanubeFields) {
      ...
      return $http
        .post('/Integration/Integration/AssociateTiendanubeFieldMapping', {
          IdList: idList,
    ...
    function integrateTiendanubeList(list, entity) {
      return $http
        .post('/Integration/Integration/IntegrateTiendanubeList', {
          IdList: list.IdList,
    ...
    function deleteList(idList) {
      return $http
        .get('/Integration/Integration/DisconnectTiendanubeList', {
    ...
    function getAssociatedFieldMapping(idList) {
      return $http
        .post('/Integration/Integration/GetTiendanubeAssociatedFieldMapping', {
          idList: idList,
        })
        .then(function (response) {
          return response.data;
