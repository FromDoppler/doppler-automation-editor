(function() {
  ...
  function siteTrackingService($http) {
    ...
    function saveEnableDisableSiteTracking(isEnabled) {
      return $http.post('/ControlPanel/CampaignsPreferences/SaveEnableDisableSiteTracking',
        {
          enable: isEnabled
        })
    ...
    function getSiteTrackingPreferences() {
      return $http.get('/ControlPanel/CampaignsPreferences/GetSiteTrackingPreferences')
        .then(function(response){
    ...
    function addOrEditDomain(domainName, domainId) {
      return $http.post('/ControlPanel/CampaignsPreferences/SaveSiteTrackingDomain',
        {
    ...
    function verifyDomain(domainId) {
      return $http.post('/ControlPanel/CampaignsPreferences/VerifyDomain',
        {
          IdDomain: domainId
        })
        .then(function(response) {
    ...
    function VerifyPushConfiguration(domainId) {
      return $http.post('/ControlPanel/CampaignsPreferences/VerifyPushConfiguration',
        {
          IdDomain: domainId
        })
        .then(function(response) {
    ...
    function canAddDomain(url) {
      return $http.post('/ControlPanel/CampaignsPreferences/CanBeRegisteredDomain',
        {
    ...
    function deleteDomain(domainId) {
      return $http.post('/ControlPanel/CampaignsPreferences/DeleteDomain',
        {
          IdDomain: domainId
        })
        .then(function(response) {
