(function() {
  ...
  angular
    .module('dopplerApp')
    .factory('zohoCrmService', zohoCrmService);

  zohoCrmService.$inject = [
    '$http'
  ];
  ...
  function zohoCrmService($http) {
    ...
    function getIntegrationStatus() {
      return $http.get('/Integration/Integration/GetZohoIntegrationStatus')
    ...
    function connect(userData) {
      return $http.post('/Integration/Integration/ConnectZoho', userData)
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function disconnect() {
      return $http.post('/Integration/Integration/DisconnectZoho')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function getZohoCrmEntities() {
      return $http.get('/Integration/Integration/GetZohoModules')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function getZohoCrmFields(module) {
      return $http.get('/Integration/Integration/GetZohoFields',
        {
          params: {
            module: module
          }
    ...
    function manualSync(){
      return $http.get('/Integration/Integration/SynchAllZohoLists')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function synchZohoCrmLists(idList){
      return $http.post('/Integration/Integration/SynchZohoLists',
        {
    ...
    function associateZohoCrmFieldMapping(idList, zohoCrmFields){
      ...
      return $http.post('/Integration/Integration/AssociateZohoFieldMapping',
        {
          IdList: idList,
    ...
    function integrateZohoCrmList(list, entity){
      return $http.post('/Integration/Integration/IntegrateZohoList',
        {
          IdList: list.IdList,
    ...
    function deleteList(idList) {
      return $http.get('/Integration/Integration/DisconnectZohoList', {
    ...
    function getAssociatedFieldMapping(idList){
      return $http.post('/Integration/Integration/GetZohoAssociatedFieldMapping',
        {
          idList: idList
        })
        .then(function(response) {
