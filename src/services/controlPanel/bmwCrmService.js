(function() {
  ...
  angular
    .module('dopplerApp')
    .factory('bmwCrmService', bmwCrmService);

  bmwCrmService.$inject = [
    '$http'
  ];
  ...
  function bmwCrmService($http) {
    ...
    function getIntegrationStatus() {
      return $http.get('/Integration/Integration/GetBmwCrmIntegrationStatus')
    ...
    function connect(userData) {
      return $http.post('/Integration/Integration/ConnectBmwCrm', userData)
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function disconnect() {
      return $http.post('/Integration/Integration/DisconnectBmwCrm')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function getEntities() {
      return $http.get('/Integration/Integration/GetBmwCrmEntities')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function getUserLists() {
      return $http.get('/Integration/Integration/GetBmwCrmUserLists')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function integrateList(list, entity) {
      return $http.post('/Integration/Integration/IntegrateBmwCrmList',
        {
          IdList: list.IdList,
    ...
    function associateFieldMapping(idList, fields) {
      ...
      return $http.post('/Integration/Integration/AssociateBmwCrmFieldMapping',
        {
          IdList: idList,
    ...
    function deleteList(idList) {
      return $http.get('/Integration/Integration/DisconnectBmwCrmList', {
    ...
    function synchLists(idList) {
      return $http.post('/Integration/Integration/SynchBmwCrmLists',
        {
    ...
    function manualSync() {
      return $http.get('/Integration/Integration/SynchAllBmwCrmLists')
        .then(function(response) {
          return response.data;
        });
    }
    ...
    function getAssociatedFieldMapping(idList) {
      return $http.post('/Integration/Integration/GetBmwCrmAssociatedFieldMapping',
        {
          idList: idList
        })
        .then(function(response) {
