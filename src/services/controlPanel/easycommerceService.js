(function () {
  ...
  easycommerceService.$inject = ['$http'];
  ...
  function easycommerceService($http) {
    ...
    function getIntegrationStatus() {
      return $http
        .get('/Integration/Integration/GetEasycommerceIntegrationStatus')
    ...
    function connect(userData) {
      return $http
        .post('/Integration/Integration/ConnectEasycommerce', userData)
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function disconnect() {
      return $http
        .post('/Integration/Integration/DisconnectEasycommerce')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function getUserLists() {
      return $http
        .get('/Integration/Integration/GetEasycommerceUserLists')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function getEasycommerceEntities() {
      return $http
        .get('/Integration/Integration/GetEasycommerceEntities')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function manualSync() {
      return $http
        .get('/Integration/Integration/SynchAllEasycommerceLists')
        .then(function (response) {
          return response.data;
        });
    }
    ...
    function synchEasycommerceLists(idList) {
      return $http
        .post('/Integration/Integration/SynchEasycommerceLists', {
    ...
    function associateEasycommerceFieldMapping(idList, easycommerceFields) {
      var fieldMappings = _.map(
        easycommerceFields,
        function (easycommerceFields) {
          var fieldMapping = {
      ...
      return $http
        .post('/Integration/Integration/AssociateEasycommerceFieldMapping', {
          IdList: idList,
    ...
    function integrateEasycommerceList(list, entity) {
      return $http
        .post('/Integration/Integration/integrateEasycommerceList', {
          IdList: list.IdList,
    ...
    function deleteList(idList) {
      return $http
        .get('/Integration/Integration/DisconnectEasycommerceList', {
    ...
    function getAssociatedFieldMapping(idList) {
      return $http
        .post(
          '/Integration/Integration/GetEasycommerceAssociatedFieldMapping',
          {
            idList: idList,
          }
        )
