(function () {
  ...
  automationReportsService.$inject = ['$http'];
  ...
  function automationReportsService($http) {
    ...
    function getResults(id, reportType, actionIds, frecuency) {
      return $http.post(
        '/Automation/ReportTask/' + resultsFrecuency[frecuency],
        {
          idScheduledTask: id,
    ...
    function getSummaryResults(id, campaignId) {
      return $http
        .get('/Automation/ReportTask/GetSummaryResults', {
          params: {
            automationId: id,
    ...
    function getSmsResults(id, reportType, smsIdList) {
      return $http
        .get('/Automation/ReportTask/GetSmsResult', {
          params: {
            idScheduledTask: id,
            reportType: reportType,
            smsIds: smsIdList,
    ...
    function exportAutomationReport(
      ...
      var urlCsvReportCampaign =
        '/Automation/ReportTask/ExportAutomationReportByCampaign';
      var urlCsvReportSubscriber =
        '/Automation/ReportTask/ExportAutomationReportBySubscriber';
      var urlCsvReport =
        reportType === 'campaign'
          ? urlCsvReportCampaign
          : urlCsvReportSubscriber;
    ...
    function getPushResults(id, pushIds, reportType) {
      return $http
        .get('/Automation/ReportTask/GetPushNotificationResult', {
          params: {
            idScheduledTask: id,
            pushIds: pushIds,
            reportType: reportType,
