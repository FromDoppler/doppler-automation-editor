(function () {
  ...
  function optionsListDataservice(
    $translate,
    ACTION_TYPE,
    CONDITIONAL_CRITERIA,
    CONDITIONAL_EVENT,
    ...
    var actionOptions = [
      {
        label: $translate.instant(
          'automation_editor.components.action.options.associate_subscriber_to_list'
        ),
        value: ACTION_TYPE.ASSOCIATE_SUBSCRIBER_TO_LIST,
      },
      {
        label: $translate.instant(
          'automation_editor.components.action.options.resend_email'
        ),
        value: ACTION_TYPE.RESEND_EMAIL,
      },
      {
        label: $translate.instant(
          'automation_editor.components.action.options.remove_subscriber_from_list'
        ),
        value: ACTION_TYPE.REMOVE_SUBSCRIBER_FROM_LIST,
      },
      {
        label: $translate.instant(
          'automation_editor.components.action.options.change_subscriber_field'
        ),
    ...
    var booleanOptions = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.boolean.yes'
        ),
        value: true,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.boolean.no'
        ),
        value: false,
      },
    ];
    ...
    var timeUnitOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.time_unit.minutes'
        ),
    ...
    var dayMoments = [
      {
        label: $translate.instant(
          'automation_editor.components.initial_condition.scheduled_date.day_moment_before'
        ),
        value: 1,
      },
      {
        label: $translate.instant(
          'automation_editor.components.initial_condition.scheduled_date.day_moment_now'
        ),
        value: 0,
      },
      {
        label: $translate.instant(
          'automation_editor.components.initial_condition.scheduled_date.day_moment_after'
        ),
        value: 2,
      },
    ];
    ...
    var pendingPaymentTimeOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.pending_order.drop_down_time_options.option120'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWO_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.pending_order.drop_down_time_options.option360'
        ),
        value: DYNAMIC_CONTENT_HOURS.SIX_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.pending_order.drop_down_time_options.option1440'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWENTYFOUR_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.pending_order.drop_down_time_options.option2880'
        ),
    ...
    var abandonedCartTimeOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.abandoned_cart.drop_down_time_options.option120'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWO_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.abandoned_cart.drop_down_time_options.option360'
        ),
        value: DYNAMIC_CONTENT_HOURS.SIX_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.abandoned_cart.drop_down_time_options.option1440'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWENTYFOUR_HOURS,
      },
    ];
    ...
    var abandonedCartWaitOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.abandoned_cart.drop_down_wait_options.option0'
        ),
    ...
    var visitedProductsTimeOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_time_options.option1440'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWENTYFOUR_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_time_options.option2880'
        ),
        value: DYNAMIC_CONTENT_HOURS.FORTYEIGHT_HOURS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_time_options.option4320'
        ),
    ...
    var visitedProductsWaitOptions = [
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_wait_options.option10080'
        ),
        value: DYNAMIC_CONTENT_HOURS.ONE_WEEK,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_wait_options.option20160'
        ),
        value: DYNAMIC_CONTENT_HOURS.TWO_WEEKS,
      },
      {
        label: $translate.instant(
          'automation_editor.sidebar.visited_products.drop_down_wait_options.option30240'
        ),
    ...
    var campaignBehaviorEvents = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.open_email'
        ),
        value: CONDITIONAL_EVENT.OPEN_EMAIL,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.email_not_open'
        ),
        value: CONDITIONAL_EVENT.EMAIL_NOT_OPEN,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.any_link_clicked'
        ),
        value: CONDITIONAL_EVENT.ANY_LINK_CLICKED,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.no_link_clicked'
        ),
        value: CONDITIONAL_EVENT.NO_LINK_CLICKED,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.any_dynamic_link_clicked'
        ),
        value: CONDITIONAL_EVENT.ANY_DYNAMIC_LINK_CLICKED,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.no_dynamic_link_clicked'
        ),
        value: CONDITIONAL_EVENT.NO_DYNAMIC_LINK_CLICKED,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.link_clicked'
        ),
        value: CONDITIONAL_EVENT.LINK_CLICKED,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.events.link_not_clicked'
        ),
    ...
    var listMembershipEvents = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.list_membership.events.belongs'
        ),
        value: CONDITIONAL_EVENT.BELONGS,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.list_membership.events.not_belongs'
        ),
    ...
    var conditionalOptions = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.campaign_behavior.label'
        ),
        value: CONDITIONAL_TYPE.CAMPAIGN_BEHAVIOR,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.list_membership.label'
        ),
        value: CONDITIONAL_TYPE.LIST_MEMBERSHIP,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.label'
        ),
        value: CONDITIONAL_TYPE.SUBSCRIBER_INFORMATION,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.site_behavior.label'
        ),
    ...
    var comparisonOperators = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.operators.less_than'
        ),
        value: CONDITIONAL_CRITERIA.LESS_THAN,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.operators.less_than_or_equals_to'
        ),
        value: CONDITIONAL_CRITERIA.LESS_THAN_OR_EQUALS_TO,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.operators.greater_than'
        ),
        value: CONDITIONAL_CRITERIA.GREATER_THAN,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.operators.greater_than_or_equals_to'
        ),
        value: CONDITIONAL_CRITERIA.GREATER_THAN_OR_EQUALS_TO,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.operators.equals_to'
        ),
    ...
    var textFieldCriteria = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.starts_with'
        ),
        value: CONDITIONAL_CRITERIA.STARTS_WITH,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.not_starts_with'
        ),
        value: CONDITIONAL_CRITERIA.NOT_STARTS_WITH,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.contains'
        ),
        value: CONDITIONAL_CRITERIA.CONTAINS,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.not_contains'
        ),
        value: CONDITIONAL_CRITERIA.NOT_CONTAINS,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.ends_with'
        ),
        value: CONDITIONAL_CRITERIA.ENDS_WITH,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.not_ends_with'
        ),
        value: CONDITIONAL_CRITERIA.NOT_ENDS_WITH,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.equals_to'
        ),
        value: CONDITIONAL_CRITERIA.EQUALS_TO,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.criteria.not_equals_to'
        ),
    ...
    var abandonedCartDefaultFields = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.abandoned_cart_information.fields.date'
        ),
      ...
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.abandoned_cart_information.fields.amount_of_products'
        ),
      ...
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.abandoned_cart_information.fields.status'
        ),
      ...
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.abandoned_cart_information.fields.total'
        ),
        embed: '[[[total]]]',
        id: 4,
        isBasic: true,
    ...
    var genderFieldOptions = [
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.gender.female'
        ),
        value: GENDER_TYPE.FEMALE,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.gender.male'
        ),
        value: GENDER_TYPE.MALE,
      },
      {
        label: $translate.instant(
          'automation_editor.components.condition.conditionals.subscriber_information.gender.n_a'
        ),
    ...
    var timesBackAutomation = [
      {
        ...
        label: $translate.instant(
          'automation_editor.components.initial_condition.site_behavior.panel.times_value0'
        ),
      },
      {
        value: TIMES_BACK_AUTOMATION.EVERY_3_MONTHS,
        label: $translate.instant(
          'automation_editor.components.initial_condition.site_behavior.panel.times_value1'
        ),
      },
      {
        value: TIMES_BACK_AUTOMATION.EVERY_6_MONTHS,
        label: $translate.instant(
          'automation_editor.components.initial_condition.site_behavior.panel.times_value2'
        ),
      },
    ];
    ...
    var service = {
      ...
      getAbandonedCartInformationDefaultFields:
        getAbandonedCartInformationDefaultFields,
    };
    ...
    function getWeekDays() {
      ...
      for (var i = 1; i <= 7; i++) {
        ...
        weekDays.push({
          label: $translate.instant(
            'automation_editor.sidebar.scheduled_date_day' + value
          ),
          value: value,
        });
      }
