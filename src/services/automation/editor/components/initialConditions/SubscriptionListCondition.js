(function() {
  ...
  angular
    ...
    .factory('SubscriptionListCondition', ['BaseInitialConditionComponent', function(BaseInitialConditionComponent) {
      ...
      SubscriptionListCondition.prototype = Object.create(BaseInitialConditionComponent.prototype);
      SubscriptionListCondition.prototype.markup = '<dp-editor-subscription-list-condition component="component"></dp-editor-subscription-list-condition>';
      SubscriptionListCondition.prototype.panelTemplate = '<div dp-editor-panel-subscription-list-condition></div>';
      ...
      SubscriptionListCondition.prototype.getCompletedPropertiesToWatch = function() {
        return [
