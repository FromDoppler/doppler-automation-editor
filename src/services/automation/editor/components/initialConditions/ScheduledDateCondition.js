(function () {
  ...
  angular
    ...
    .factory('ScheduledDateCondition', [
      '$injector',
      'BaseInitialConditionComponent',
      function ($injector, BaseInitialConditionComponent) {
        ...
        ScheduledDateCondition.prototype = Object.create(
          BaseInitialConditionComponent.prototype
        );
        ScheduledDateCondition.prototype.markup =
          '<dp-editor-scheduled-date-condition component="component"></dp-editor-scheduled-date-condition>';
        ScheduledDateCondition.prototype.panelTemplate =
        ...
        ScheduledDateCondition.prototype.setFrequency = function (
          frequencyData
        ) {
        ...
        ScheduledDateCondition.prototype.getPropertiesToWatch = function () {
          return ['frequency', 'suscriptionLists'];
        };
