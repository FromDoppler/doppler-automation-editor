(function () {
  ...
  angular
    ...
    .factory('CampaignBehaviorCondition', [
      '$injector',
      'ScheduledDateCondition',
      'SEND_TYPE',
      function ($injector, ScheduledDateCondition, SEND_TYPE) {
        ...
        CampaignBehaviorCondition.prototype = Object.create(
          ScheduledDateCondition.prototype
        );
        CampaignBehaviorCondition.prototype.markup =
          '<dp-editor-campaign-behavior-condition component="component"></dp-editor-scheduled-date-condition>';
        CampaignBehaviorCondition.prototype.panelTemplate =
          '<div dp-editor-panel-campaign-behavior-condition class="dp-editor-panel-campaign-condition"></div>';
        ...
        CampaignBehaviorCondition.prototype.getPropertiesToWatch = function () {
          var properties =
            ScheduledDateCondition.prototype.getPropertiesToWatch();
          return properties.concat(['sendType', 'suscriptionLists']);
        };
