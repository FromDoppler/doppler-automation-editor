(function() {
  ...
  angular
    ...
    .factory('DynamicContentCondition', ['$injector', 'BaseInitialConditionComponent', '$translate', 'AUTOMATION_TYPE', function($injector, BaseInitialConditionComponent, $translate, AUTOMATION_TYPE){

      function DynamicContentCondition(data) {
        BaseInitialConditionComponent.call(this, data);
      }
      
      DynamicContentCondition.prototype = Object.create(BaseInitialConditionComponent.prototype);
      DynamicContentCondition.prototype.markup = '<dp-editor-dynamic-content-condition component="component"></dp-editor-dynamic-content-condition>';
      DynamicContentCondition.prototype.panelTemplate = '<div dp-editor-panel-dynamic-content-condition class="dp-editor-panel-dynamic-content-condition"></div>';
      ...
      DynamicContentCondition.prototype.setData = function(data) {
        ...
        if (data.hasOwnProperty('eventIntervalMinutes')) {
          ...
          this.eventIntervalMinutesLabel = $translate.instant('automation_editor.sidebar.' + this.automationType + '.drop_down_time_options.option' + data.eventIntervalMinutes);
        }
