(function () {
  ...
  angular
    ...
    .factory('PushNotificationCondition', [
      'BaseInitialConditionComponent',
      '$injector',
      'SEND_TYPE',
      function (BaseInitialConditionComponent, $injector, SEND_TYPE) {
        ...
        PushNotificationCondition.prototype = Object.create(
          BaseInitialConditionComponent.prototype
        );
        PushNotificationCondition.prototype.markup =
          '<dp-editor-push-notification-condition component="component"></dp-editor-push-notification-condition>';
        PushNotificationCondition.prototype.panelTemplate =
          '<div dp-editor-panel-push-notification-condition class="dp-editor-panel-push-notification-condition"></div>';
        ...
        PushNotificationCondition.prototype.checkCompleted = function () {
          if (this.sendType === SEND_TYPE.INMEDIATE) {
            ...
            this.completed =
              this.frequency !== null &&
              this.frequency.checkCompleted() &&
              this.domains.length > 0;
          }
        };

        PushNotificationCondition.prototype.setFrequency = function (
          frequencyData
        ) {
