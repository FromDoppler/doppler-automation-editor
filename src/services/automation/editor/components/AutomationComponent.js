(function() {
  ...
  angular
    ...
    .factory('AutomationComponent', ['$injector', 'AUTOMATION_COMPLETED_STATE', 'AUTOMATION_STATE', 'COMPONENT_TYPE', 'utils',
      function($injector, AUTOMATION_COMPLETED_STATE, AUTOMATION_STATE, COMPONENT_TYPE, utils) {
        ...
        AutomationComponent.prototype.setData = function(data) {
          ...
          if (data.hasOwnProperty('initialCondition')) {
            if (!this.initialCondition) {
              this.initialCondition = automation.createCondition(data.initialCondition);
            } else {
        ...
        AutomationComponent.prototype.addChildComponent = function(component, index) {
          this.children.splice(index, 0, component);
        };

        AutomationComponent.prototype.removeChildComponent = function(component) {
        ...
        AutomationComponent.prototype.getEmailChildById = function(idEmail) {
          return _.find(this.children, function(child) {
            return child.type === COMPONENT_TYPE.CAMPAIGN && child.id === idEmail;
          });
        };
        ...
        AutomationComponent.prototype.getEmailChildren = function(childUid, childIndex) {
          var self = this;
          var emailComponents = [];

          _.each(_.filter(this.children, function(child) {
        ...
        AutomationComponent.prototype.isFlowComplete = function() {
          ...
          hasStartDateExpired = (this.initialCondition && this.initialCondition.hasStartDateExpired)? this.initialCondition.hasStartDateExpired : false;
          while (isFlowComplete && index < this.children.length) {
            ...
            if (isFlowComplete && !hasAtLeastOneCampaign && this.children[index].type === COMPONENT_TYPE.CAMPAIGN) {
              hasAtLeastOneCampaign = true;
            }
            if (isFlowComplete && this.children[index].type === COMPONENT_TYPE.CONDITION) {
              conditionFlowComplete = this.children[index].isFlowComplete(hasAtLeastOneCampaign);
            ...
            if (isFlowComplete && !hasWarnings && this.children[index].type === COMPONENT_TYPE.DELAY
          ...
          && this.completed !== AUTOMATION_COMPLETED_STATE.WITH_SITE_TRACKING_DISABLED
          && this.completed !== AUTOMATION_COMPLETED_STATE.WITH_DELETED_DOMAIN
          && this.completed !== AUTOMATION_COMPLETED_STATE.WITH_NON_VERIFIED_DOMAIN
          && this.completed !== AUTOMATION_COMPLETED_STATE.WITH_NON_REGISTERED_DOMAIN
          ...
          if (this.state !== AUTOMATION_STATE.STOPPED &&
