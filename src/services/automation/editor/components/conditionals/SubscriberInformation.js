(function() {
  ...
  angular
    ...
    .factory('SubscriberInformation', ['$injector', 'BaseConditional', 'DUPLICATE_STATE', function($injector, BaseConditional, DUPLICATE_STATE) {
      ...
      SubscriberInformation.prototype = Object.create(BaseConditional.prototype);
