(function() {
  ...
  angular
    ...
    .factory('BaseConditional', ['$translate', 'DUPLICATE_STATE', 'utils', function($translate, DUPLICATE_STATE, utils) {
      ...
      // Defaults.
        ...
        this.label = $translate.instant('automation_editor.components.condition.conditionals.' + this.type + '.label');
      }
