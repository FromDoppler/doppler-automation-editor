    ...
    .factory('SiteBehavior', [
      ...
      function(
        ...
        SiteBehavior.prototype.checkCompleted = function() {
          ...
          if (!this.domain.url || !this.domain.url.length || this.domain.url.indexOf('?') > -1
                || this.domain.status !== DOMAIN_STATUS.VERIFIED
                || this.domain.idDomain === 0 || (this.duplicate !== DUPLICATE_STATE.FALSE
        ...
        SiteBehavior.prototype.isEqual = function(conditional) {
          var isEqual = !!this.domain && !!conditional.domain
          && this.domain.url.toLowerCase() === conditional.domain.url.toLowerCase();
          return isEqual;
        };
        ...
        function findDomain(actualDomain, domains) {
          ...
          actualDomain.status = !existDomain ? DOMAIN_STATUS.ERROR : existDomain.Status;
          return actualDomain;
        }
