(function() {
  ...
  angular
    ...
    .factory('ChangeSubscriberField', ['BaseOperation', 'userFieldsDataservice', function(BaseOperation, userFieldsDataservice) {
      ...
      ChangeSubscriberField.prototype = Object.create(BaseOperation.prototype);

      ChangeSubscriberField.prototype.setData = function(data) {
        BaseOperation.prototype.setData.call(this, data);
        if (data.hasOwnProperty('field') && !userFieldsDataservice.isFieldDeleted(data.field)) {
