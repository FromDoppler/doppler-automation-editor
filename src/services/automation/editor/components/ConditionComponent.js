(function () {
  ...
  angular.module('dopplerApp.automation.editor').factory('ConditionComponent', [
    '$injector',
    'BaseComponent',
    'COMPONENT_TYPE',
    'CONDITION_BRANCH',
    ...
    function (
      ...
      ConditionComponent.prototype.markup =
        '<dp-editor-condition class="component--container condition" component="component" branch="branch"></dp-editor-condition>';
      ConditionComponent.prototype.panelTemplate =
        '<div dp-editor-panel-condition class="dp-editor-panel-condition"></div>';
      ...
      ConditionComponent.prototype.addChildComponent = function (
        child,
        index,
        branch
      ) {
      ...
      ConditionComponent.prototype.removeChildComponent = function (
        component,
        branch
      ) {
      ...
      ConditionComponent.prototype.addConditional = function (
        newConditional,
        oldConditional,
        index
      ) {
        ...
        conditionals.splice(
          index >= 0 ? index : conditionals.length,
          0,
          newConditional
        );
      ...
      ConditionComponent.prototype.removeConditional = function (
        conditionalToRemove
      ) {
      ...
      ConditionComponent.prototype.getConditionalIndex = function (
        conditional
      ) {
      ...
      ConditionComponent.prototype.getEmailChildren = function (
        childUid,
        childIndex
      ) {
        var self = this;
        ...
        _.each(
          _.filter(this[branch], function (child) {
      ...
      ConditionComponent.prototype.getChildrenToTransfer = function (
        index,
        branch
      ) {
      ...
      ConditionComponent.prototype.hasNextComponent = function (
        component,
        branch
      ) {
      ...
      ConditionComponent.prototype.checkCompleted = function () {
        ...
        var hasAtLeastOneCampaignOrSiteBehavior = !!_.find(
          this.conditionals,
      ...
      ConditionComponent.prototype.hasWarnings = function () {
        ...
        hasWarnings =
          !this.positiveSiblings.length && !this.negativeSiblings.length;
        if (!hasWarnings) {
          hasWarnings = !!(
            (this.positiveSiblings.length &&
              this.positiveSiblings[this.positiveSiblings.length - 1].type ===
                COMPONENT_TYPE.DELAY) ||
            (this.negativeSiblings.length &&
              this.negativeSiblings[this.negativeSiblings.length - 1].type ===
                COMPONENT_TYPE.DELAY)
          );
        }
      ...
      ConditionComponent.prototype.isFlowComplete = function (
        atLeastOneCampaign
      ) {
        ...
        var allChildren = conditionsDataservice.getAllConditionChildren(
          this.uid
        );
        var index = 0;
        ...
        while (isFlowComplete && index < allChildren.length) {
          ...
          if (
            ...
            allChildren[index].type === COMPONENT_TYPE.CAMPAIGN
          ) {
            hasAtLeastOneCampaign = true;
          }
          if (
            isFlowComplete &&
            allChildren[index].type === COMPONENT_TYPE.CONDITION
          ) {
            conditionFlowComplete = allChildren[index].isFlowComplete(
              hasAtLeastOneCampaign
            );
      ...
      ConditionComponent.prototype.getPropertiesToWatch = function () {
        return ['name', 'operator', 'time', 'timeUnit'];
      };
