...
describe('AutomationComponent', function() {
  ...
  beforeEach(inject(function( _AutomationComponent_, _COMPONENT_TYPE_, _AUTOMATION_TYPE_, _AUTOMATION_STATE_, _AUTOMATION_COMPLETED_STATE_, _SEND_TYPE_, _CONDITION_OPERATOR_, _TIME_UNIT_, _TIMES_BACK_AUTOMATION_) {
  ...
  it('should be able to instantiate a new EMPTY Automation component for Subscription List', function() {
    ...
    // Act
    var emptyAutomationComponent = new AutomationComponent(automationComponentParams);
    ...
    expect(emptyAutomationComponent.initialCondition.type).toEqual(emptyAutomationComponent.automationType);
 ...
 it('should be able to instantiate a new automation component with data for Subscription List', function() {
    ...
    // Act
    var automationComponent = new AutomationComponent(automationComponentParams);
    // Assert
    expect(automationComponent).not.toBeUndefined();
    expect(automationComponent.type).toEqual(COMPONENT_TYPE.AUTOMATION);
    expect(automationComponent.completed).toBe(automationComponentParams.completed);
  ...
  it('should be able to instantiate a new automation component with data for Campaign Behavior', function() {
    ...
    expect(automationComponent).not.toBeUndefined();
    expect(automationComponent.type).toEqual(COMPONENT_TYPE.AUTOMATION);
    expect(automationComponent.initialCondition.sendType).toBe(automationComponentParams.initialCondition.sendType);
  ...
  it('should be able to instantiate a new automation component with data for Site Behavior', function() {
    ...
    expect(automationComponent).not.toBeUndefined();
    expect(automationComponent.type).toEqual(COMPONENT_TYPE.AUTOMATION);
    expect(automationComponent.initialCondition.operator).toBe(automationComponentParams.initialCondition.operator);
    expect(automationComponent.initialCondition.verificationTime).toBe(automationComponentParams.initialCondition.verificationTime);
    expect(automationComponent.initialCondition.timeUnit).toBe(automationComponentParams.initialCondition.timeUnit);
    expect(automationComponent.initialCondition.timesBackAutomation).toBe(automationComponentParams.initialCondition.timesBackAutomation);
