(function () {
  ...
  automationDataservice.$inject = ['$http'];
  ...
  function automationDataservice($http) {
    ...
    function getAutomation(id) {
      var automationUrl =
        '/Automation/Automation/GetAutomationModel?idScheduledTask=' + id;
      return $http.get(automationUrl);
    }

    function saveChanges(automation) {
      return $http.post(
        '/Automation/Automation/SaveAutomationModel',
        automation
      );
    }
    ...
    function getSubscribersLists(
      ...
      return $http
        .get('/Automation/Task/GetSubscribersLists', {
          params: {
            idSegment: idSegment,
            idLabel: idLabel,
    ...
    function getUserLabels() {
      return $http
        .get('/Automation/Task/GetUserLabels')
        .then(function (response) {
    ...
    function getAutomationDefaultName() {
      return $http
        .get('/Automation/Automation/GetAutomationName')
        .then(function (response) {
    ...
    function getEmailLinks(idCampaign) {
      return $http.get(
        '/Automation/Automation/GetAutomationCampaignLink?idCampaign=' +
          idCampaign
      );
    }
    ...
    function startAutomationCampaign(id) {
      var automationUrl =
        '/Automation/Automation/StartAutomationCampaign?idScheduledTask=' + id;
      return $http.get(automationUrl);
    }

    function stopAutomationCampaign(id) {
      var automationUrl =
        '/Automation/Automation/StopAutomationCampaign?idScheduledTask=' + id;
      return $http.get(automationUrl);
    }

    function pauseAutomationCampaign(id) {
      var automationUrl =
        '/Automation/Automation/PauseAutomationCampaign?idScheduledTask=' + id;
      return $http.get(automationUrl);
    }

    function getHtmlContent(idCampaign) {
      return $http
        .get('/Campaigns/Content/GetHTMLJsonContent', {
          params: {
            idCampaign: idCampaign,
            replaceTags: true,
          },
    ...
    function getListsForSendTest() {
      return $http
        .get('/Automation/Automation/GetSubscribersListsForTest')
        .then(function (response) {
    ...
    function validateAndAutoCompleteRSS(url) {
      return $http
        .get('/Automation/Automation/IsValidRSS', {
          params: {
            RssFeed: url,
          },
        })
    ...
    function getHtmlContentForPreview(idCampaign) {
      return $http
        .get('/Automation/Content/GetContentCampaign', {
          params: {
            idCampaign: idCampaign,
          },
        })
    ...
    function getSiteBehaviorStatus() {
      return $http
        .get('/Automation/Automation/GetSiteBehaviorStatus')
        .then(function (response) {
