(function () {
  ...
  function changesManager(
    ...
    function createChangeObject(changeDetails) {
      ...
      switch (changeDetails.type) {
        ...
        case CHANGE_TYPE.ADD_CONDITIONAL:
          ...
          undo = function (parameters) {
            var conditionComponent = automation.getComponentByUid(
              parameters.conditionUid
            );
          ...
          redo = function (parameters) {
            ...
            var newConditional = automation.createConditional(
              parameters.newConditional
            );
            conditionComponent.addConditional(
              newConditional,
              parameters.oldConditional,
              parameters.index
            );
        ...
        case CHANGE_TYPE.PROPERTY:
          ...
          undo = function (parameters) {
            ...
            if (
              component.type === COMPONENT_TYPE.CAMPAIGN ||
              component.type === COMPONENT_TYPE.DELAY ||
              component.type === COMPONENT_TYPE.GOTO_STEP
            ) {
        ...
        case CHANGE_TYPE.CONDITIONAL_PROPERTY:
          ...
          undo = function (parameters) {
            ...
            var conditionalComponent =
              conditionComponent.conditionals[parameters.conditionalIndex];
    ...
    function updateGotoLine(component, idGoto, lastId) {
      goToService.markComponentInGotoSelection(lastId, false, [
        'goto-connected',
      ]);
      ...
      goToService.markComponentInGotoSelection(component.uid, true, [
        'goto-connected',
      ]);
      goToService.markComponentInGotoSelection(idGoto, true, [
        'goto-connected',
      ]);
    }
    ...
    function setSelectedComponent(component) {
      if (
        selectedElementsService.getSelectedComponent() !== component &&
