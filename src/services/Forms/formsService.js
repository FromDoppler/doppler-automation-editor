(function() {
  ...
  function formsService($http) {
    ...
    function getFormConfig() {
      return $http.get('/Lists/Form/GetUserFormConfig').then(function(response) {
        return response.data.config;
      });
    }

    function getIntegrations(idForm) {
      return $http.get('/Lists/Form/GetIntegrations', {
        params: {
          idForm: idForm
        }
    ...
    function saveFormLandingDistributionSettings(settings) {
      return $http.post('/Lists/Form/SaveFormLandingDistributionSettings', settings)
        .then(function(response) {
          return response.data;
        });
    }
