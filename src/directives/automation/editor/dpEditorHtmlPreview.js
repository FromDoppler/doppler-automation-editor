(function() {
  ...
  function dpEditorHtmlPreview($compile) {
    ...
    function link(scope, element, attrs) {
      ...
      attOptions.value = '{iframeautoresize: true,autohidemode: false, background: "#DCDCDC", cursorcolor: "#7F7F7F", cursorborder: 0, railalign: "center", zindex: 99999}';
