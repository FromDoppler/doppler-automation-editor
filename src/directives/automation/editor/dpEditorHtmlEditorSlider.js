(function () {
  ...
  function dpEditorHtmlEditorSlider(
    $rootScope,
    automation,
    changesManager,
    CONTENT_TYPE,
    ...
    var directive = {
      restrict: 'E',
      templateUrl:
        'angularjs/partials/automation/editor/directives/dp-editor-html-editor-slider.html',
      link: link,
    };
    ...
    function link(scope) {
      ...
      if (selectedEmail.id === 0) {
        automation.saveChanges().then(function () {
          ...
          automation
            .getHtmlContent(selectedEmail.id)
      ...
      scope.tinyOptions = {
        ...
        theme: 'advanced',
        plugins:
          'imagemanager,style,layer,table,save,advhr,advimage,emotions,imgmap,inlinepopups,contextmenu,paste,directionality,fullpage,fullscreen,noneditable,visualchars',
        ...
        theme_advanced_buttons1:
          'code,|,fullscreen,|,bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,formatselect,fontselect,fontsizeselect',
        theme_advanced_buttons2:
          'cut,copy,paste,pastetext,pasteword,|,search,replace,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,image,imgmap,cleanup,|,insertdate,inserttime,preview,|,forecolor,backcolor',
        theme_advanced_buttons3:
          'tablecontrols,|,hr,removeformat,visualaid,|,sub,sup,|,charmap,emotions,iespell,advhr',
        theme_advanced_buttons4:
          'newdocument,|,insertlayer,moveforward,movebackward,absolute,|,styleprops,spellchecker,|,cite,abbr,acronym,del,ins,attribs,|,visualchars,nonbreaking,blockquote,pagebreak,|,insertfile|,ltr,rtl',
      ...
      scope.saveTinyEditorContent = function () {
        automation
          .saveTinyEditorContent(selectedEmail.id, scope.html.val)
