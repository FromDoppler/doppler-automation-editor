(function () {
  ...
  function dpEditorCondition(
    ...
    var directive = {
      ...
      templateUrl:
        'angularjs/partials/automation/editor/directives/components/dp-editor-condition.html',
      link: link,
    };
    ...
    function link(scope, element) {
      var negativeConditonalEvents =
        optionsListDataservice.getNegativeConditionalEvents();
      ...
      scope.canBeRemoved = function () {
        scope.showDeleteWarning =
          scope.component.positiveSiblings.length > 0 &&
      ...
      scope.isVerificationTimeNeeded = function () {
        return !!(
          scope.component &&
          _.find(scope.component.conditionals, function (conditional) {
            return (
      ...
      scope.hasNegativeConditionalEvents = function () {
        ...
        if (
          scope.component &&
          scope.component.operator === CONDITION_OPERATOR.AND
        ) {
          _.each(scope.component.conditionals, function (conditional) {
            hasNegativeEvent = _.includes(
              negativeConditonalEvents,
              conditional.event
            );
            if (hasNegativeEvent) {
              return false;
      ...
      scope.getConditionSummary = function () {
        ...
        if (scope.component.name && scope.component.name.length) {
          ...
          (!scope.component.conditionals.length ||
            !scope.component.conditionals[0].completed)
        ) {
          innerHtml += $translate.instant(
            'automation_editor.canvas.condition_placeholder'
          );
        } else {
          index = 0;
          truncated = false;
          ...
          if (verificationTime) {
            innerHtml +=
              ...
              $translate.instant(
                'automation_editor.components.condition.canvas_description.check_for'
              ) +
              '</strong>';
            if (scope.component.time) {
              ...
              if (parseInt(scope.component.time) === 1) {
                innerHtml += $translate.instant(
                  'automation_editor.components.condition.canvas_description.singular_' +
                    scope.component.timeUnit
                );
              } else {
                innerHtml += $translate.instant(
                  'automation_editor.components.condition.canvas_description.plural_' +
                    scope.component.timeUnit
                );
              }
              innerHtml += '</strong>';
              ...
              innerHtml +=
                '<span class="brackets">&#91;&#91;&#91;&hellip;&#93;&#93;&#93;</span>';
              innerHtml +=
                '<strong class="selected">' +
                $translate.instant(
                  'automation_editor.components.condition.canvas_description.of_time'
                ) +
                '</strong>';
            }
            innerHtml +=
              '<span>' +
              $translate.instant(
                'automation_editor.components.condition.canvas_description.if_subscriber'
              ) +
              '</span>';
          }
          // conditionals resume
          while (index < scope.component.conditionals.length && !truncated) {
            ...
            if (
              ...
              if (isFirstConditional(conditional.type, conditional.uid)) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.campaign_behavior.canvas_description.intro_lower'
                  ) +
                  '</span>';
              }
              innerHtml +=
                '<strong class="selected">&nbsp;' +
                $translate.instant(
                  'automation_editor.components.condition.conditionals.campaign_behavior.canvas_description.' +
                    conditional.event
                ) +
                '</strong> ';
              if (
                ...
                innerHtml +=
                  '<span class="h-break-word link--default">' +
                  conditional.link.url +
                  '&nbsp;</span>';
              }
              if (
                conditional.event !== CONDITIONAL_EVENT.OPEN_EMAIL &&
                conditional.event !== CONDITIONAL_EVENT.EMAIL_NOT_OPEN
              ) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.campaign_behavior.canvas_description.nexus_of'
                  ) +
                  '</span>';
              }
              innerHtml +=
              ...
              conditional.type === CONDITIONAL_TYPE.LIST_MEMBERSHIP &&
              conditional.completed
            ) {
              if (isFirstConditional(conditional.type, conditional.uid)) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.list_membership.canvas_description.intro_' +
                      (index === 0 && !verificationTime ? 'upper' : 'lower')
                  ) +
                  '</span>';
              }
              innerHtml +=
                '<strong class="selected">&nbsp;' +
                $translate.instant(
                  'automation_editor.components.condition.conditionals.list_membership.canvas_description.' +
                    conditional.event
                ) +
                '</strong>';
              innerHtml +=
                '<span>&nbsp;&quot;' +
                conditional.subscriptionList.ListName +
                '&quot;</span>';
              // subscriber information
            } else if (
              conditional.type === CONDITIONAL_TYPE.SUBSCRIBER_INFORMATION &&
              conditional.completed
            ) {
              ...
              if (isFirstConditional(conditional.type, conditional.uid)) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.intro_' +
                      (index === 0 && !verificationTime ? 'upper' : 'lower')
                  );
                innerHtml +=
                  '<strong class="selected">&nbsp;' +
                ...
                innerHtml +=
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.intro_subject'
                  ) + '</span>';
              } else {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.intro_possessive'
                  ) +
                  '</span>';
                innerHtml +=
                  '<strong class="selected">&nbsp;' +
              ...
              if (
                conditional.field.type === FIELD_TYPE.DATE ||
                conditional.field.type === FIELD_TYPE.REAL ||
                conditional.field.type === FIELD_TYPE.STRING ||
                ...
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.criteria.' +
                      conditional.field.criteria
                  ) +
                  '</span>';
              }
              if (
                ...
                innerHtml +=
                  '<span>&quot;' + conditional.field.value + '&quot;</span>';
              }
              if (conditional.field.type === FIELD_TYPE.DATE) {
                innerHtml += formatDate(conditional.field.date);
              }
              if (
                conditional.field.type === FIELD_TYPE.BOOLEAN ||
                conditional.field.type === FIELD_TYPE.COUNTRY ||
                conditional.field.type === FIELD_TYPE.GENDER ||
                conditional.field.type === FIELD_TYPE.CONSENT ||
                conditional.field.type === FIELD_TYPE.SCORE ||
                conditional.field.type === FIELD_TYPE.ORIGIN ||
                conditional.field.type === FIELD_TYPE.PERMISSION
              ) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.intro_is'
                  ) +
                  '</span>';
              }
              if (
                ...
                innerHtml +=
                  '<span>&quot;' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.subscriber_information.canvas_description.' +
                      (conditional.field.value ? 'positive' : 'negative')
                  ) +
                  '&quot;</span>';
              }
              if (conditional.field.type === FIELD_TYPE.COUNTRY) {
                innerHtml +=
                  '<span>&quot;' +
                  conditional.field.country.name +
                  '&quot;</span>';
              }
              ...
              if (conditional.field.type === FIELD_TYPE.SCORE) {
                innerHtml +=
                  '<span>&quot;' +
                  conditional.field.score.name +
                  '&quot;</span>';
              }
              if (conditional.field.type === FIELD_TYPE.ORIGIN) {
                innerHtml +=
                  '<span>&quot;' +
                  conditional.field.origin.name +
                  '&quot;</span>';
              }
              innerHtml += '</span>';
            } else if (
              conditional.type ===
                CONDITIONAL_TYPE.ABANDONED_CART_INFORMATION &&
              conditional.completed
            ) {
              innerHtml += '<span class="text-too-long">';
              if (isFirstConditional(conditional.type, conditional.uid)) {
                ...
                innerHtml +=
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.abandoned_cart_information.the_cart'
                  ) + '</span>';
              } else {
                innerHtml +=
                  '<span>' +
              ...
              if (isFirstConditional(conditional.type, conditional.uid)) {
                innerHtml +=
                  '<span>' +
                  $translate.instant(
                    'automation_editor.components.condition.conditionals.site_behavior.the_subscriber'
                  );
              }
              innerHtml +=
                '<strong class="selected">' +
                $translate.instant(
                  conditional.domain.visitedPage
                    ? 'automation_editor.components.condition.conditionals.site_behavior.visited'
                    : 'automation_editor.components.condition.conditionals.site_behavior.no_visited'
                ) +
                '</strong>' +
                $translate.instant(
                  'automation_editor.components.condition.conditionals.site_behavior.separator'
                );
              innerHtml +=
                '<span class="h-break-word link--default">' +
                conditional.domain.url +
                '</span>';
              innerHtml +=
                conditional.domain.visitedTimes > 1 &&
                conditional.domain.visitedPage
                  ? $translate.instant(
                      'automation_editor.components.condition.conditionals.site_behavior.at_least'
                    ) +
                    ' ' +
              ...
              innerHtml +=
                ...
                $translate.instant(
                  conditional.domain.visitedTimes > 1 &&
                    conditional.domain.visitedPage
                    ? 'automation_editor.components.condition.conditionals.site_behavior.more_times'
                    : ''
                );
              innerHtml += '</span>';
            }
            ...
            if (index <= scope.component.conditionals.length - 1) {
              innerHtml +=
                '<span class="operator">' +
                $translate.instant(
                  'automation_editor.components.condition.canvas_description.operator_' +
                    scope.component.operator
                ) +
                '</span>';
            }
            // If there are more items but the MAX_ITEMS_TO_SHOW has already been reached then the ellipsis must be added
            if (
              index < scope.component.conditionals.length &&
              index === MAX_ITEMS_TO_SHOW
            ) {
      ...
      scope.getDelaySummary = function () {
        ...
        innerHtml +=
          '<span>' +
          $translate.instant(
            'automation_editor.components.condition.canvas_description.verification_after'
          ) +
          '</span>';
        if (scope.component.time) {
          ...
          innerHtml +=
            '<span class="delay-brackets">&#91;&#91;&#91;&hellip;&#93;&#93;&#93;</span>';
          innerHtml +=
            '<span>' +
            $translate.instant(
              'automation_editor.components.condition.canvas_description.verification_time'
            ) +
            '</span>';
        }
      ...
      scope.removeAndTransferChildren = function () {
        ...
        var conditionIndex = automation.getComponentIndex(
          scope.component,
        ...
        if (scope.component.positiveSiblings.length) {
          ...
          childrenToTransfer = scope.component.getChildrenToTransfer(
            0,
            CONDITION_BRANCH.POSITIVE
          );
        } else {
          branch.origin = CONDITION_BRANCH.NEGATIVE;
          childrenToTransfer = scope.component.getChildrenToTransfer(
            0,
            CONDITION_BRANCH.NEGATIVE
          );
        }
      ...
      function isFirstConditional(type, uid) {
        var conditionalsByType = _.filter(
          scope.component.conditionals,
      ...
      function formatDate(date) {
        return (
          '<span>&quot;' +
          moment(date).format(
            $translate.instant('automation_editor.date_format').toUpperCase()
          ) +
          '&quot;</span>'
        );
      }
      ...
      function isOnGotoSelection() {
        ...
        return (
          ...
          previousSelectedComponent.type === COMPONENT_TYPE.GOTO_STEP
        );
      }
      ...
      scope.onMouseEnterOverComponent = function () {
        if (
          isOnGotoSelection() &&
          isComponentAvailableToBeConnected(
