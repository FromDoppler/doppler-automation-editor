(function() {
  ...
  function dpEditorDelay($translate) {
    var directive = {
      ...
      templateUrl: 'angularjs/partials/automation/editor/directives/components/dp-editor-delay.html',
      link: link
    };
    ...
    function link(scope) {
      ...
      scope.getTimeUnitLabel = function() {
        var timeUnitLabel = $translate.instant('automation_editor.sidebar.time_unit.' + selectedComponent.timeUnit);
        timeUnitLabel = timeUnitLabel.charAt(0).toLowerCase() + timeUnitLabel.slice(1);
