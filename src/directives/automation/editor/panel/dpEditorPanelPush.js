(function () {
  ...
  function dpEditorPanelPush(
    ...
    var directive = {
      restrict: 'AE',
      templateUrl:
        'angularjs/partials/automation/editor/directives/panel/dp-editor-panel-push.html',
      link: link,
    };
    ...
    function link(scope) {
      ...
      function uploadImageSelect(e) {
        ...
        e.preventDefault();
        progressCounter();
        scope.imageFile = e.dataTransfer
      ...
      scope.charactersCountTitle = scope.selectedComponent.pushMessageTitle
        ? scope.selectedComponent.pushMessageTitle.length
        : 0;
      scope.charactersCountBody = scope.selectedComponent.pushMessageBody
        ? scope.selectedComponent.pushMessageBody.length
        : 0;
      ...
      scope.clearErrorsOnEmptyLink = function () {
        return (
          scope.selectedComponent.pushMessageOnClickLink !== '' ||
          clearLinkErrors()
        );
      };
