(function() {
  ...
  angular
    ...
    .directive('dpEditorPanelScheduledDateCondition', dpEditorPanelScheduledDateCondition);
  ...
  function dpEditorPanelScheduledDateCondition($translate, automation, FIELD_TYPE, FREQUENCY_TYPE, LIST_SELECTION_STATE,
    ...
    var directive = {
      restrict: 'AE',
      templateUrl: 'angularjs/partials/automation/editor/directives/panel/initialConditions/dp-editor-panel-scheduled-date-condition.html',
      link: link
    };
    ...
    function link(scope, element) {
      ...
      element.ready(function() {
        if (scope.selectedComponent.frequency && scope.selectedComponent.frequency.type === FREQUENCY_TYPE.DAY_YEAR) {
          updateDeletedFields();
        }
      });
      ...
      function updateDeletedFields(index) {
        ...
        _.each(scope.deletedFields, function(deletedField) {
          scope.customFieldForm['customField' + deletedField.index].$setValidity('deletedField', false);
        });
