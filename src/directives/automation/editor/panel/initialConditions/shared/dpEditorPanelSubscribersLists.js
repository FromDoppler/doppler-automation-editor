(function() {
  ...
  dpEditorPanelSubscribersLists.$inject = [
    'automation'
  ];
  ...
  function dpEditorPanelSubscribersLists(automation) {
    var directive = {
      restrict: 'E',
      templateUrl: 'angularjs/partials/automation/editor/directives/panel/initialConditions/shared/dp-editor-panel-subscribers-lists.html',
      link: link
    };
