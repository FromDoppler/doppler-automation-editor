(function () {
  ...
  angular
    ...
    .directive(
      'dpEditorPanelPushNotificationCondition',
      dpEditorPanelPushNotificationCondition
    );
  ...
  function dpEditorPanelPushNotificationCondition(
    automation,
    DOMAINS_SELECTION_STATE,
    FREQUENCY_TYPE,
    optionsListDataservice,
    ...
    var directive = {
      restrict: 'AE',
      templateUrl:
        'angularjs/partials/automation/editor/directives/panel/initialConditions/dp-editor-panel-push-notification-condition.html',
      link: link,
    };
