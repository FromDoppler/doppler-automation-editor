(function () {
  ...
  dpControlPanelSection.$inject = ['$translate'];
  ...
  function dpControlPanelSection($translate) {
    var directive = {
      ...
      templateUrl:
        'angularjs/partials/controlPanel/directives/dp-control-panel-section.html',
      link: link,
    };
    ...
    function link($scope) {
      $translate.onReady().then(function () {
        if ($scope.type === 'DKIM') {
          ...
          $scope.linkText = $translate.instant(
            'control_panel.dkim.subtitle_link_text'
          );
        }
