(function () {
  ...
  angular
    ...
    .controller(
      'SubscribersScoringPreferencesCtrl',
      SubscribersScoringPreferencesCtrl
    );
  ...
  function SubscribersScoringPreferencesCtrl(
    $scope,
    $translate,
    subscribersScoringService
  ) {
    ...
    subscribersScoringService.getScoringPreferences().then(function (response) {
    ...
    $scope.saveScoringPreferences = function () {
      if (!$scope.errorValues) {
        ...
        subscribersScoringService
          .saveScoringPreferences(scoringInformation)
