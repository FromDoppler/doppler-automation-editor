(function () {
  ...
  function wooCommerceIntegrationCtrl(
    $translate,
    ModalService,
    wooCommerceService,
    INTEGRATION_CODES,
    ...
    vm.getStatus = function () {
      return wooCommerceService.getIntegrationStatus().then(function (result) {
        if (result.success) {
          if (!!result.model) {
            // eslint-disable-line
        ...
        inputs: {
          data: {
            title: $translate.instant(
              'wooCommerce_integration.connected.disconnect_popup.title'
            ),
            description: $translate.instant(
              'wooCommerce_integration.connected.disconnect_popup.description'
            ),
